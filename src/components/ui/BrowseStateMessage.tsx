...
// (tracks haven't arrived yet) and a search that returned nothing. Without
// this the scene would be a featureless void at exactly the moment the user
// most needs feedback.
export function BrowseStateMessage(): ReactElement | null {
  ...
  // Initial load — gentle pulsing dot
  return (
    <div className="absolute inset-0 z-30 flex items-center justify-center pointer-events-none">
